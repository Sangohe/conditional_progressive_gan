...
G           = EasyDict(func='networks.G_paper', structure='linear')             # Options for generator network.
D           = EasyDict(func='networks.D_paper', structure='linear')             # Options for discriminator network.
...
desc += '-acdc_masks';          dataset = EasyDict(tfrecord_dir='acdc_with_masks');         dataset.masks = True
...
desc += '-preset-v2-1gpu'; num_gpus = 1; sched.minibatch_base = 4; sched.minibatch_dict = {4: 16, 8: 16, 16: 16, 32: 16, 64: 16, 128: 16}; sched.G_lrate_dict = {1024: 0.0015}; sched.D_lrate_dict = EasyDict(sched.G_lrate_dict); train.total_kimg = 12000
